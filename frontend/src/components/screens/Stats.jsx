...
function Stats() {
  ...
  return (
    <div className="container m-4 p-2 card">
      <div className="row">
        <div className="col-md-3">
          {" "}
          <Link to="/" className="btn btn-dark my-1 m-3">
            Go Back
          </Link>
        </div>
        <h5 className="m-2"> Number of Connection Requests in every month Visualization</h5>
